...
from hstu_blackwell.cute.testing import (
    attention_ref,
    generate_qkv,
...
from hstu_blackwell.cute.interface import flash_attn_func, flash_attn_varlen_func, flash_attn_combine
...
def test_flash_attn_varlen_output(
    ...
    for dv, attention_chunk in itertools.product(dv_vals, attention_chunk_vals):
        ...
        # q_ref = torch.ones_like(q_ref)
        # k_ref = torch.ones_like(k_ref)
        # v_ref = torch.ones_like(v_ref)
...
if __name__ == "__main__":
    print("Testing flash_attn_varlen_output")
